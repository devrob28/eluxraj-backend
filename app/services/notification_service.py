...
Send alerts via Email, SMS, and Push notifications
"""
import httpx
...
class NotificationService:
    ...
    def __init__(self):
        ...
        self.from_email = getattr(settings, 'FROM_EMAIL', 'alerts@eluxraj.ai')
    ...
    async def send_alert_notification(
        ...
        <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #1a1a24; padding: 24px; border-radius: 0 0 12px 12px; color: white;">
                ...
                <p style="color: #9ca3af; margin-top: 20px; font-size: 14px;">
                    Condition: Price went {direction} ${threshold:,.2f}
                </p>
                <a href="https://eluxraj.ai/dashboard.html" style="display: block; background: linear-gradient(135deg, #7c3aed, #06b6d4); color: white; text-align: center; padding: 14px; border-radius: 8px; text-decoration: none; font-weight: bold; margin-top: 20px;">
                    View Dashboard →
                </a>
            </div>
            <p style="color: #6b7280; font-size: 12px; text-align: center; margin-top: 16px;">
                You're receiving this because you set a price alert on ELUXRAJ.<br>
                <a href="https://eluxraj.ai/dashboard.html" style="color: #7c3aed;">Manage alerts</a>
            </p>
        </div>
        """
        ...
        # Push notification would require Web Push setup - placeholder for now
        results["push"] = notify_push  # Will implement with service worker
